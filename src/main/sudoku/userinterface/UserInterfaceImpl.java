...
import javafx.scene.text.Font; // what's the difference versus java.awt.font?
...
public class UserInterfaceImpl implements IUserInterfaceContract.View,
    ...
    private void drawSudokuBoard(Group root) {
        ...
        boardBackground.setWidth(BOARD_WIDTH_HEIGHT);
        boardBackground.setHeight(BOARD_WIDTH_HEIGHT);
