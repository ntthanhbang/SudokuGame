...
/**
 * Manages the window, and displays a popup notification when the user completes the puzzle.
 */
public class UserInterfaceImpl implements IUserInterface.View,
    ...
    private static final String SUDOKU = "Sudoku - Final Project - OOP class";
    ...
    /**
     * Each time the user makes an input (which can be 0 to delete a number), we update the userinterface appropriately.
     */
    @Override
